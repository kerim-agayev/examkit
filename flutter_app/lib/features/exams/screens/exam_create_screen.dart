  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        bottom: PreferredSize(preferredSize: const Size.fromHeight(32), child: Padding(padding: const EdgeInsets.only(bottom: 8), child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [_StepCircle(1, true), _StepLine(), _StepCircle(2, false), _StepLine(), _StepCircle(3, false), _StepLine(), _StepCircle(4, false)]))),
      ),
          ...
          children: [
            ...
            Card(
              child: Padding(
                ...
                child: Column(
                  children: [
                    TextField(controller: _titleCtrl, decoration: const InputDecoration(labelText: 'Sınav Başlığı *', hintText: 'örn: Riyaziyyat Fənn İmtahanı', counterText: '0/100'), maxLength: 100, onChanged: (_) => setState(() {})),
                    ...
                    InkWell(
                      onTap: () async {
                        await showModalBottomSheet(
                          ...
                          builder: (_) => SizedBox(
                            height: 300,
                            child: ListView(
                              children: ['9-A Sinifi', '10-B Matematik', '11-A Fizik', '12-C Kimya'].map((g) => ListTile(title: Text(g), trailing: _selectedGroup == g ? const Icon(Icons.check, color: Color(0xFF2563EB)) : null, onTap: () { setState(() => _selectedGroup = g); Navigator.pop(context); })).toList(),
                            ),
                          ),
                        );
                      },
                      child: Container(
                        ...
                        child: Row(
                          children: [
                            const Icon(Icons.group, color: Color(0xFF2563EB)),
        ...
        child: Padding(
          ...
          child: SizedBox(
            ...
            child: ElevatedButton(
              onPressed: _canNext ? () => context.push('/exams/create/settings') : null,
